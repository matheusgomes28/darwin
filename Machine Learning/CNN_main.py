...
def main():
  ...
  parser.add_argument('learning_rate', help='learning rate of the CNN', nargs='?', type=float, default=default_learning_rate)
  parser.add_argument('num_steps', help='number of steps to take in the training stage', nargs='?', type=int, default=default_num_steps)
  parser.add_argument('batch_size', help='CNN batch size (power of 2)', nargs='?', type=int, default=default_batch_size)
